...
export const registerThunk = createAppAsyncThunk<IAuthRegisterResponse, IAuthRegisterRequest>(
    'auth/register',
    async (payload, { rejectWithValue }) => {
        try {
...
export const activateThunk = createAppAsyncThunk<IAuthActivateResponse, IAuthActivateRequest>(
    'auth/activate',
    async (payload, { rejectWithValue }) => {
        try {
...
export const resendOtpThunk = createAppAsyncThunk<IAuthResendOtpResponse, IAuthResendOtpRequest>(
    'auth/resendOtp',
    async (payload, { rejectWithValue }) => {
        try {
...
export const selectTenantThunk = createAppAsyncThunk<ISelectTenantResponse, ISelectTenantRequest>(
    'auth/selectTenant',
    async (payload, { rejectWithValue }) => {
        try {
...
export const selectRoleThunk = createAppAsyncThunk<ISelectRoleResponse, ISelectRoleRequest>(
    'auth/selectRole',
...
export const selectAgentThunk = createAppAsyncThunk<ISelectAgentResponse, ISelectAgentRequest>(
    'auth/selectAgent',
    async (payload, { getState, rejectWithValue }) => {
        try {
            const { auth } = getState()

            return await tenantService.selectAgent(payload, auth.selectedTenant ?? undefined)
        } catch (error) {
